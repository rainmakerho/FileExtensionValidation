...
namespace FileExtensionValidation.Test
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void Should_True_Validate_JPG_ffd8ffdb()
        {
            var fileName = "37.jpg";
            var filePath = Path.Combine(_folderPath, fileName);
            var fileData = File.ReadAllBytes(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_JPG_ffd8ffdb()
        {
            var fileName = "37.jpg";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_7Z()
        {
            var fileName = "2.7z";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_BMP()
        {
            var fileName = "3.bmp";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_TIFF()
        {
            var fileName = "4.tif";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_RTF()
        {
            var fileName = "5.rtf";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_PPT()
        {
            var fileName = "6.ppt";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_PPTX()
        {
            var fileName = "7.pptx";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_DOC()
        {
            var fileName = "8.doc";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_DOCX()
        {
            var fileName = "9.docx";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_ODT()
        {
            var fileName = "10.odt";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_ODS()
        {
            var fileName = "11.ods";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_XLSX()
        {
            var fileName = "12.xlsx";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_XLS()
        {
            var fileName = "13.xls";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_DAT()
        {
            var fileName = "14.dat";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_AVI()
        {
            var fileName = "15.avi";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_WMV()
        {
            var fileName = "17.wmv";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_JPEG()
        {
            var fileName = "18.jpeg";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_TXT()
        {
            var fileName = "19.txt";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_GIF()
        {
            var fileName = "20.gif";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_RM()
        {
            var fileName = "21.rm";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_PNG()
        {
            var fileName = "22.png";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_PDF()
        {
            var fileName = "23.pdf";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_ODP()
        {
            var fileName = "24.odp";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_WAV()
        {
            var fileName = "25.wav";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_ODG()
        {
            var fileName = "26.odg";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_3GP()
        {
            var fileName = "27.3gp";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_M4V()
        {
            var fileName = "28.m4v";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_MKV()
        {
            var fileName = "29.mkv";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_MP4()
        {
            var fileName = "30.mp4";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_MPG()
        {
            var fileName = "31.mpg";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_RAR()
        {
            var fileName = "32.rar";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_MP3()
        {
            var fileName = "33.mp3";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_TIF()
        {
            var fileName = "34.tif";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_MPEG()
        {
            var fileName = "35.mpeg";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
        ...
        [TestMethod]
        public void Should_True_Validate_FS_ZIP()
        {
            var fileName = "36.zip";
            var filePath = Path.Combine(_folderPath, fileName);
            var fs = File.OpenRead(filePath);
